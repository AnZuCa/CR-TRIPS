...
public class PreguntaResource {
    ...
    /**
     * Retrieves representation of an instance of presentacion.PreguntaResource
    ...
    @Produces(javax.ws.rs.core.MediaType.APPLICATION_JSON)
        public Response RegistrarPreguntaTour(Pregunta pregunta) {
    
        boolean flag = Model.instance().RegistrarPregunta(pregunta);
        if (flag == true)
        {
